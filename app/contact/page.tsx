      ...
      <main className="flex-1">
        ...
        <section className="py-20 bg-muted/30">
          <div className="container mx-auto px-4 text-center">
            <h1 className="font-serif text-5xl md:text-7xl font-bold mb-6 text-balance">Get in Touch</h1>
              ...
              <div>
                ...
                <div className="space-y-8">
                  <p className="text-muted-foreground leading-relaxed">
                    We're here to help! Whether you have questions about our products, need styling advice, or want to
                    know more about shipping and returns, our team is ready to assist you.
                  </p>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-muted-foreground mb-8">
                Looking for quick answers? Check out our FAQ section for common questions about orders, shipping, and
                product care.
              </p>
